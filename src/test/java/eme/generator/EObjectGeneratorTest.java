...
//        EClass result = null; //(EClass) generator.generateEClassifier(abstractClass);
...
//        EClass result = null; //(EClass) generator.generateEClassifier(testClass);
//        generator.completeGeneration();
...
//        EClass result = null; //(EClass) generator.generateEClassifier(normalClass);
//        generator.completeGeneration();
...
//        }
//        EEnum result = null; //(EEnum) generator.generateEClassifier(enumeration);
//        generator.completeGeneration();
...
//        model.add(subClass);
//        EClass result = null; //(EClass) generator.generateEClassifier(subClass);
//        generator.completeGeneration();
...
//        EClass result = null; //(EClass) generator.generateEClassifier(extractedInterface);
//        generator.completeGeneration();
...
//        EClass result = null; //(EClass) generator.generateEClassifier(subClass);
//        EClass result2 = null; //(EClass) generator.generateEClassifier(subClass2);
//        generator.completeGeneration();
//        assertEquals("SubClass", result.getName());
...
//        EClass result = null; //(EClass) generator.generateEClassifier(subInterface);
//        EClass result2 = null; //(EClass) generator.generateEClassifier(subInterface2);
//        generator.completeGeneration();
